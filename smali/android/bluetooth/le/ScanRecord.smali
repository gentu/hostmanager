...
.method public static parseFromBytes([B)Landroid/bluetooth/le/ScanRecord;
    ...
    .line 233
    .local v30, "serviceDataUuidBytes":[B
    invoke-static/range {v30 .. v30}, Landroid/bluetooth/BluetoothUuid;->parseUuidFrom([B)Landroid/os/ParcelUuid;

    move-result-object v29

    .line 235
    .local v29, "serviceDataUuid":Landroid/os/ParcelUuid;
    add-int v3, v19, v31
    ...
    .line 242
    .end local v28    # "serviceDataArray":[B
    .end local v29    # "serviceDataUuid":Landroid/os/ParcelUuid;
    .end local v30    # "serviceDataUuidBytes":[B
    .end local v31    # "serviceUuidLength":I
    :sswitch_7
    ...
    .line 246
    .local v25, "manufacturerDataBytes":[B
    const/16 v27, 0x0

    .line 247
    .local v27, "previousManuDataBytes":[B
    move/from16 v0, v26
    ...
    .end local v27    # "previousManuDataBytes":[B
    check-cast v27, [B

    .line 249
    .restart local v27    # "previousManuDataBytes":[B
    if-eqz v27, :cond_3
    ...
    .line 252
    .local v23, "fullManufacturerDataBytes":[B
    const/4 v3, 0x0
    ...
    invoke-static {v0, v3, v1, v10, v11}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    .line 256
    .end local v23    # "fullManufacturerDataBytes":[B
    :cond_3
    const-string v3, "ScanRecord"
    ...
    .end local v22    # "fieldType":I
    .end local v24    # "length":I
    .end local v25    # "manufacturerDataBytes":[B
    .end local v26    # "manufacturerId":I
    .end local v27    # "previousManuDataBytes":[B
    :cond_4
    move/from16 v18, v19
