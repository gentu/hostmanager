.class Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;
...
.method public constructor <init>(Lcom/samsung/android/hostmanager/connectionmanager/ServiceController;Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;)V
    ...
    .prologue
    .line 2763
    iput-object p1, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->this$0:Lcom/samsung/android/hostmanager/connectionmanager/ServiceController;
    ...
    iput-object v0, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->mDevice:Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;

    .line 2764
    iput-object p2, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->mDevice:Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;
    ...
    const-string v2, "SPPConnectionRetryTask for device "
...
.method public run()V
    ...
    const-string v6, "Retry SPP Connection for "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->mDevice:Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;
    ...
    sget-object v5, Lcom/samsung/android/hostmanager/connectionmanager/Event$ServiceType;->ALL:Lcom/samsung/android/hostmanager/connectionmanager/Event$ServiceType;
    ...
    .line 2776
    iget-object v4, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->mDevice:Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;
    ...
    .line 2779
    iget-object v4, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->this$0:Lcom/samsung/android/hostmanager/connectionmanager/ServiceController;
    ...
    iget-object v5, p0, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController$SPPConnectionRetryTask;->mDevice:Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/samsung/android/hostmanager/connectionmanager/WearableState;->getServiceState(Lcom/samsung/android/hostmanager/connectionmanager/WearableDevice;Lcom/samsung/android/hostmanager/connectionmanager/Event$ServiceType;)Lcom/samsung/android/hostmanager/connectionmanager/Event$ServiceState;
    ...
    .line 2780
    invoke-virtual {v4, v5}, Lcom/samsung/android/hostmanager/connectionmanager/Event$ServiceState;->equals(Ljava/lang/Object;)Z
    ...
    const-string v5, "SPP Reconnection after remote fail"
    ...
    const-string v5, "Request SPP connection!"
    ...
    .line 2798
    .end local v0    # "isHFPConnected":Z
    .end local v1    # "isSPPConnected":Z
    :cond_0
    :goto_0
    return-void

    .line 2794
    .restart local v0    # "isHFPConnected":Z
    .restart local v1    # "isSPPConnected":Z
    :cond_1
    invoke-static {}, Lcom/samsung/android/hostmanager/connectionmanager/ServiceController;->access$000()Ljava/lang/String;

    move-result-object v4

    const-string v5, "SPP already connected or HFP already disconnected, do not retry SPPConnection"
